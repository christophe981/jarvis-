...
Ce workspace est le Jarvis personnel de Christophe Lachaud. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Christophe Lachaud, j'ai 47 ans et je vis à Périgueux en Dordogne. Marié depuis 27 ans et père de 3 enfants, je suis agent de maîtrise (poste d'équivalence) en VRD dans la fonction publique territoriale depuis 15 ans, avec un parcours varié derrière moi (restauration, génie civil, bâtiment). En quête de sens et de nouvelles perspectives, je me lance en parallèle comme OBM (Online Business Manager) freelance : gestion de projets, d'outils, d'opérations et de structuration pour des TPE/PME, dirigeants et créateurs de contenu.

Mes objectifs prioritaires actuels : finaliser et formuler clairement mon offre OBM, décrocher mes 2 premiers clients ciblés, et générer un complément de revenu de 2 500 à 5 000 euros par mois.

À long terme, je veux quitter la fonction publique pour vivre pleinement de mon activité, atteindre un revenu synonyme de liberté et de sérénité pour ma famille, et bâtir une expertise reconnue dans une niche précise.

Le domaine où j'ai besoin du plus d'aide en ce moment : la prospection, pour décrocher un premier client, analyser son besoin réel, puis affiner la suite de l'accompagnement à partir de là.
...
- **Rappelez-moi de sauvegarder** : à la fin d'un échange important ou d'une session productive, proposez-moi un petit rappel du type "pensez à `/update`" pour que je conserve une trace durable de notre travail
